...
public class ZxingUtils {
    private static String domain = "http://localhost/audio/";
...
//        return pathname;
    ...
    public static BufferedImage drawImage(InputStream inputStream) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        //背景图片地址
        String backgroundPath = "/Users/apple/Desktop/DSC_2768.jpg";
        InputStream inputStream = null;
        try {
            //合成二维码和背景图
            BufferedImage image = ZxingUtils.drawImage(backgroundPath, zxingImage, 10, 10);
//            //绘制文字
//            //读取本地字体
...
//        } catch (IOException | FontFormatException e) {
        ...
        //保存的图片路径
        String originalFileName = "/Users/apple/Desktop/new.jpg";
        try {
            //保存为本地图片
